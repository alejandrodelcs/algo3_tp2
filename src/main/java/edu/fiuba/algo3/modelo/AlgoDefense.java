...
public class AlgoDefense {
    ...
    public void buildsADefense() {
        //ArrayList<Poins>listOfPlacesWhereADefenseCanBeBuild = gameboard.AskBuilDefence()//TODO// here the game board have to ask where the player want to build a defense(the return is a list of posibles coordinates)
    ...
    public boolean canPlayerBuy( Tower tower ){//TODO// here a player can buy "anything" not only towers
